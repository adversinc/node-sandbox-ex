...
var default_options = {
  ...
  // The name of the sandboxed process to set
	processName: "Sandbox Showel"
}
...
Sandbox.prototype.run = function() {
	...
	var startOptions = {
		...
		processName: this._options.processName,
	};
	...
	cprocess.on("error", (err) => {
		if(err.code == "ENOENT") {
			console.error("Can not spawn, node not found " + this._options.node_command);
		} else {
