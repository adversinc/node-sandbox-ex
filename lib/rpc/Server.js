...
Server.prototype._handleRequest = function(/*Object*/data){
    ...
    try{
        ...
        //normally we'd return here, but we should let the error
        //bubble up to code outside of our control, so the dev that's
        //using this lib gets a stack trace on the console.
        throw e;
    }
...
Server.prototype._handleError = function(/*Error*/error, /*String?*/id, /*int?*/code){
    var out = JSON.stringify({
        ...
        error: {
          ...
          /*
          // We do not send stack and such to client
            data: {
                stack: error.stack,
